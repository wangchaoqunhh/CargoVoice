...
public class WaveSideBar extends View {
    ...
    private OnTouchChange onTouchChange;
    ...
    public void setOverLetter(TextView mOverLetter) {
        this.mOverLetter = mOverLetter;
    }
    ...
    public void setOnTouchChange(OnTouchChange onTouchChange) {
        this.onTouchChange = onTouchChange;
    }
    public interface OnTouchChange {
        void onDown();
        void onMove();
        void onUp();
    }
