...
var shape2;
function changeMoon(){
	clearInterval(shape1);
  clearInterval(shape2);
	shape1=setInterval(transform,10);
...
function resetMoon(){
  clearInterval(shape1);
  clearInterval(shape2);
	shape2=setInterval(moonreset,5);
	
}

function transform(){
	//if (options.perlin.time < 11){
	//options.perlin.time = options.perlin.time + 0.1;
	//}
	if (options.perlin.morph < 12){
	options.perlin.morph = options.perlin.morph + 0.2;
	}
	if(options.perlin.morph >= 12)
	{
		clearInterval(shape1);
...
function moonreset(){
	//if (options.perlin.time > 5){
	//options.perlin.time = options.perlin.time - 0.1;
	//}
	if (options.perlin.morph > 0){
	options.perlin.morph = options.perlin.morph - 0.2;
	}
		if(options.perlin.morph <=0 )
	{ 
