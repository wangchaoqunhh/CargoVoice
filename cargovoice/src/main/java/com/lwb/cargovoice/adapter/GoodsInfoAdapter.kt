 ...
 * 我的询价用  货件信息
 */
class GoodsInfoAdapter(data: List<EnquiryDetailsResponse.CommodityListBean?>?) :
        BaseQuickAdapter<EnquiryDetailsResponse.CommodityListBean, BaseViewHolder>(R.layout.cargovoice_item_details_goods_type1, data) {
    override fun convert(helper: BaseViewHolder, item: EnquiryDetailsResponse.CommodityListBean) {
        item.apply {
