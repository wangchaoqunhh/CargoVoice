package com.cargo.login.contentObserver;
...
public class SmsObserver extends ContentObserver {
    ...
    public SmsObserver(Context context, Handler handler, String phone, SmsListener listener) {
        super(handler);
    ...
    public void onChange(boolean selfChange, Uri uri) {
        ...
        if (mCursor != null) {
            ...
            if (mCursor.moveToFirst()) {
                ...
                if (mPhone != null && !address.equals(mPhone)) {
                    return;
                }
                if (!body.contains("铁扇网")) {
                    return;
                }
                // 正则表达式截取短信中的6位验证码
